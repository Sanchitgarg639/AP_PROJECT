        ...
        if($rows == 1){
            while($data = mysqli_fetch_assoc($result)){
                if(password_verify($lpass, $data['pass'])){
                    ...
                    $_SESSION['userhouse'] = $data['house_no'];
                    $_SESSION['userarea'] = $data['area'];
                    $_SESSION['userpincode'] = $data['pincode'];
                    $_SESSION['userstate'] = $data['state'];
                    $_SESSION['usercountry'] = $data['country'];
                    $_SESSION['useraddress'] = $data['house_no'].' '.$data['area'].' '.$data['city'].' - '.$data['pincode'].' '.$data['state'].' '.$data['country'];
                ...
                else{ $pass_err = "Error! Password is incorrecet. "; }
            }
        }
