            ...
            <form action="search.php" method="GET" style="display: flex;">
                <div class="wrapper">
                    <div class="searchbar">
                        ...
                        <input class="input" id="search" type="text" name="searchbar" placeholder="Search for the worlds amazing collection of arts and paintings..." onchange="openPage()" autocomplete="off">
